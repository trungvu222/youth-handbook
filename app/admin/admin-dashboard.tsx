...
export default function AdminDashboard() {
  ...
  const [selectedUnitFilter, setSelectedUnitFilter] = useState<string | null>(
    null,
  );
      ...
      <div className="min-h-screen bg-red-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-red-700">
            Đang tải HỆ THỐNG QUẢN LÝ ĐOÀN VIÊN TRUNG ĐOÀN 196...
          </p>
        </div>
      </div>
    );
  ...
  const menuItems = [
    ...
    {
      id: "activities",
      label: "Sinh hoạt đoàn",
      icon: Activity,
      path: "/admin/activities",
    },
    {
      id: "ratings",
      label: "Xếp loại chất lượng đoàn",
      icon: Star,
      path: "/admin/ratings",
    },
    {
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-red-600 via-red-500 to-orange-500 p-6 text-white shadow-2xl">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <RefreshCw
                className={`h-4 w-4 transition-transform ${loadingStats ? "animate-spin" : "group-hover:rotate-180"}`}
              />
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-3 animate-in slide-in-from-top duration-300">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-red-600">
              Nhấn "Làm mới" để thử lại hoặc đăng nhập lại.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
          ...
          <div className="relative">
            ...
            <div className="mt-2 h-1.5 bg-gray-100 rounded-full overflow-hidden group-hover:bg-white/20">
              <div
                ...
                style={{
                  width: `${stats.overview.totalMembers > 0 ? (stats.overview.activeMembers / stats.overview.totalMembers) * 100 : 0}%`,
                }}
              ></div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-1 px-2 py-0.5 bg-purple-100 rounded-full group-hover:bg-white/20 transition-colors">
                <span className="text-xs font-semibold text-purple-600 group-hover:text-white">
                  {stats.overview.upcomingActivities} sắp
                </span>
              </div>
            </div>
            <div className="mt-3 group-hover:text-white transition-colors">
            ...
            <div className="mt-2 h-1.5 bg-gray-100 rounded-full overflow-hidden group-hover:bg-white/20">
              <div
                ...
                style={{
                  width: `${stats.overview.totalActivities > 0 ? (stats.overview.completedActivities / stats.overview.totalActivities) * 100 : 0}%`,
                }}
              ></div>
            </div>
          </div>
        ...
        <div className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl p-4 overflow-hidden transition-all duration-500">
          ...
          <div className="relative">
            ...
            <div className="mt-3 group-hover:text-white transition-colors">
              <p className="text-xs text-gray-500 group-hover:text-amber-100">
                Tổng điểm RL
              </p>
              <p className="text-2xl font-bold mt-0.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-bold text-gray-900">
                Xếp loại chất lượng đoàn
              </h3>
            </div>
            <span className="text-sm text-gray-500">
              {stats.overview.totalMembers} đoàn viên
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-3xl font-bold text-red-600">
                {stats.membersByRank.xuatSac}
              </p>
              <div className="mt-2 h-2 bg-red-200 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-red-500 to-pink-500 rounded-full transition-all duration-500"
                  style={{
                    width: `${stats.overview.totalMembers > 0 ? (stats.membersByRank.xuatSac / stats.overview.totalMembers) * 100 : 0}%`,
                  }}
                ></div>
              </div>
            ...
            >
              ...
              <p className="text-3xl font-bold text-green-600">
                {stats.membersByRank.kha}
              </p>
              <div className="mt-2 h-2 bg-green-200 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-green-500 to-emerald-500 rounded-full transition-all duration-500"
                  style={{
                    width: `${stats.overview.totalMembers > 0 ? (stats.membersByRank.kha / stats.overview.totalMembers) * 100 : 0}%`,
                  }}
                ></div>
              </div>
              <p className="text-xs text-green-600 mt-1">
                {stats.overview.totalMembers > 0
                  ? (
                      (stats.membersByRank.kha / stats.overview.totalMembers) *
                      100
                    ).toFixed(1)
                  : 0}
                %
            ...
            >
              ...
              <p className="text-3xl font-bold text-amber-600">
                {stats.membersByRank.trungBinh}
              </p>
              <div className="mt-2 h-2 bg-amber-200 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-amber-500 to-yellow-500 rounded-full transition-all duration-500"
                  style={{
                    width: `${stats.overview.totalMembers > 0 ? (stats.membersByRank.trungBinh / stats.overview.totalMembers) * 100 : 0}%`,
                  }}
                ></div>
              </div>
            ...
            >
              ...
              <p className="text-3xl font-bold text-gray-600">
                {stats.membersByRank.yeu}
              </p>
              <div className="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-gray-500 to-slate-500 rounded-full transition-all duration-500"
                  style={{
                    width: `${stats.overview.totalMembers > 0 ? (stats.membersByRank.yeu / stats.overview.totalMembers) * 100 : 0}%`,
                  }}
                ></div>
              </div>
              <p className="text-xs text-gray-600 mt-1">
                {stats.overview.totalMembers > 0
                  ? (
                      (stats.membersByRank.yeu / stats.overview.totalMembers) *
                      100
                    ).toFixed(1)
                  : 0}
                %
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-gray-500">
              {stats.membersByUnit.length} chi đoàn
            </span>
          </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {unit.activeCount}/{unit.memberCount} hoạt động
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      ...
                      <div className="w-20 h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${unit.memberCount > 0 ? (unit.activeCount / unit.memberCount) * 100 : 0}%`,
                          }}
                        ></div>
                      </div>
                    </div>
            ...
            {stats.recentActivities.map((activity, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 text-xs text-gray-500">
                  ...
                  <span>
                    👥 {activity.participants}/{stats.overview.totalMembers}{" "}
                    tham gia
                  </span>
                </div>
              </div>
        ...
        >
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 text-left hover:bg-red-50 transition-colors ${
                    activeTab === item.id
                      ? "bg-red-100 border-r-4 border-red-600 text-red-700"
                      : "text-gray-700"
                  }`}
                >
                  <Icon
                    className={`h-5 w-5 ${activeTab === item.id ? "text-red-600" : "text-gray-500"}`}
                  />
                  {sidebarOpen && (
          ...
          <div className="p-4 border-t border-gray-200 bg-white">
            ...
            >
              ...
              {sidebarOpen && (
                <span className="ml-3 font-medium truncate">Đăng xuất</span>
              )}
            </button>
          </div>
        </div>
